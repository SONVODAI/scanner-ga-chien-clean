#!/usr/bin/env python3
"""
Blind Benchmark 13 — Phase 3H.12 Proposition-Key Resolution for Same-Question Detection.

Orchestration and reporting ONLY. Does NOT modify research logic.
Frozen research commit: 223080a0d (Phase 3H.12).
Uses SAME frozen panel fingerprint as BB01–BB12.
...
BENCHMARK_ID = "blind_benchmark_13"
BENCHMARK_VERSION = "bb13_v1"
SESSION_ID = "bb13-autonomous-001"
FROZEN_RESEARCH_COMMIT = "223080a0d"
    ...
    base.update(
        {
            ...
            "bb12_primary_question": (
                "Does Phase 3H.11 evidence-gated novelty valuation reduce representation-only "
                "novelty inflation during opportunity ranking without suppressing independent research?"
            ),
            "modification_policy": "NO_RESEARCH_LOGIC_CHANGES_BEFORE_DURING_OR_AFTER_BB12",
        }
    )
    return base
...
def main() -> None:
    ...
    print("=== BLIND BENCHMARK 12: verify frozen commit ===")
    ...
    comparison = build_bb11_bb12_scientific_comparison(
        bb12_baseline, bb11, stop_continue, interventions, novelty_report, remaining
    )
    ...
    (ARTIFACTS / "BB12_REPORT.md").write_text(report, encoding="utf-8")
