...
# Post-diagnosis remediation — NOT autonomous forward evidence.
RECOVERY_MANUAL_REMEDIATION = "RECOVERY_MANUAL_REMEDIATION"

FORWARD_EVIDENCE_MODES = frozenset({LIVE_FORWARD})
NON_FORWARD_MODES = frozenset(
    {
...
class RunPhase(str, Enum):
    ...
    FORECAST_MEMORY_COMPLETED = "FORECAST_MEMORY_COMPLETED"
